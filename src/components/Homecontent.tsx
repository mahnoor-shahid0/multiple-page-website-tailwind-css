...
<h1 className="text-6xl font-bold drop-shadow-md" data-aos="fade-up">Welcome to WristWonders</h1>
<p className="text-2xl mt-4">Your one-stop shop for the best watches</p>
<button className="mt-6 px-6 py-3 bg-black hover:bg-slate-700 rounded-md font-bold">Shop Now</button>
</div>
    </section>   
  );
};
